...
import org.scalatest.{AsyncWordSpecLike, BeforeAndAfterAll, MustMatchers, WordSpecLike}
import scala.concurrent.ExecutionContext.Implicits.global
import scala.concurrent.{ExecutionContext, Future}

class SwarmStartTest extends TestKit(ActorSystem("test")) with WordSpecLike
  with MustMatchers
  with ScalaFutures
  with MockFactory
